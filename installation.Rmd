...
7.  Double click the 'nf-cre_workshop' folder to go inside of it
...
2.  Connect to the code tunnel you are running on Cheaha (instructions on how to create and use a tunnel are [here](#install_vscode))
